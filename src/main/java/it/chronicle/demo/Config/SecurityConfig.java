package it.chronicle.demo.Config;
...
import it.chronicle.demo.Services.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        .requestMatchers("/register", "/", "/articles", "/images/**", "/articles/details/**", "/categories/search/{id}", "/search/{id} " , "/articles/search").permitAll()
